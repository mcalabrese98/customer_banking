...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"You're interest earned {interest_earned} & your account balance is {updated_savings_balance}.")
    ...
    # ADD YOUR CODE HERE
    print(f"You're interest earned {interest_earned} & your account balance is {updated_cd_balance}.")
